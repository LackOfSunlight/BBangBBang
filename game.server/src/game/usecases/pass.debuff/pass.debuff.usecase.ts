...
import { GlobalFailCode, CardType, WarningType } from '@core/generated/common/enums';
...
import { passDebuffResponseForm, warnNotificationPacketForm } from '@common/converters/packet.form';
import { setBombTimer } from '@game/services/set.bomb.timer.service';
import { userUpdateNotificationPacketForm } from '@common/converters/packet.form';
...
const passDebuffUseCase = async (
	...
	try {
		...
		const explosionTime = setBombTimer.clearTimer(timerKey);
		setBombTimer.startBombTimer(room, toUser, explosionTime);
