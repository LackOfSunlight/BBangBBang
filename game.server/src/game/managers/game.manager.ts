import { CardType, CharacterStateType, PhaseType } from '@core/generated/common/enums';
import { Room } from '@game/models/room.model';
import characterSpawnPosition from '@data/character.spawn.position.json';
import { CharacterPositionData } from '@core/generated/common/types';
...
import { positionUpdateNotificationForm } from '@common/converters/packet.form';
import roomManger, { roomPhase, roomTimers } from './room.manager';
import { setBombTimer } from '@game/services/set.bomb.timer.service';
import { cardPool, getCard } from '@core/network/dispatcher/apply.card.dispacher';
import { IPeriodicEffectCard } from '@common/types/card';
