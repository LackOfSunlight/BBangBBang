...
import cardContainmentUnitEffect, { debuffContainmentUnitEffect } from '../card.containment_unit.effect';
...
describe('CardContainmentUnitCardEffects', () => {
  ...
  describe('cardContainmentUnitEffect', () => {
    ...
    it('대상 유저에게 디버프가 적용되는지', async () => {
      ...
      expect(updateCharacterFromRoom).toHaveBeenCalledWith(1, 'user2', expect.objectContaining({
