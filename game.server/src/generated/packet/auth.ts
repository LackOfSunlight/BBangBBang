...
/**
 * @generated from protobuf message C2SProfileRequest
 */
export interface C2SProfileRequest {
    /**
     * @generated from protobuf field: string supabaseId = 1
     */
    supabaseId: string;
}
/**
 * @generated from protobuf message S2CProfileResponse
 */
export interface S2CProfileResponse {
    /**
     * @generated from protobuf field: bool success = 1
     */
    success: boolean;
    ...
    message: string;
    /**
     * @generated from protobuf field: UserData userData = 3
     */
    userData?: UserData;
    /**
     * @generated from protobuf field: GlobalFailCode failCode = 4
     */
    failCode: GlobalFailCode;
}
...
class C2SRegisterRequest$Type extends MessageType<C2SRegisterRequest> {
    ...
    create(value?: PartialMessage<C2SRegisterRequest>): C2SRegisterRequest {
        ...
        message.password = "";
        if (value !== undefined)
            reflectionMergePartial<C2SRegisterRequest>(this, message, value);
        return message;
    }
...
class S2CRegisterResponse$Type extends MessageType<S2CRegisterResponse> {
    ...
    create(value?: PartialMessage<S2CRegisterResponse>): S2CRegisterResponse {
        ...
        message.failCode = 0;
        if (value !== undefined)
            reflectionMergePartial<S2CRegisterResponse>(this, message, value);
        return message;
    }
...
class C2SLoginRequest$Type extends MessageType<C2SLoginRequest> {
    ...
    create(value?: PartialMessage<C2SLoginRequest>): C2SLoginRequest {
        ...
        message.password = "";
        if (value !== undefined)
            reflectionMergePartial<C2SLoginRequest>(this, message, value);
        return message;
    }
...
class S2CLoginResponse$Type extends MessageType<S2CLoginResponse> {
    ...
    create(value?: PartialMessage<S2CLoginResponse>): S2CLoginResponse {
        ...
        message.failCode = 0;
        if (value !== undefined)
            reflectionMergePartial<S2CLoginResponse>(this, message, value);
        return message;
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class C2SProfileRequest$Type extends MessageType<C2SProfileRequest> {
    constructor() {
        super("C2SProfileRequest", [
            { no: 1, name: "supabaseId", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<C2SProfileRequest>): C2SProfileRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.supabaseId = "";
        if (value !== undefined)
            reflectionMergePartial<C2SProfileRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: C2SProfileRequest): C2SProfileRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string supabaseId */ 1:
                    message.supabaseId = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: C2SProfileRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string supabaseId = 1; */
        if (message.supabaseId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.supabaseId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message C2SProfileRequest
 */
export const C2SProfileRequest = new C2SProfileRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class S2CProfileResponse$Type extends MessageType<S2CProfileResponse> {
    constructor() {
        super("S2CProfileResponse", [
            { no: 1, name: "success", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "userData", kind: "message", T: () => UserData },
            { no: 4, name: "failCode", kind: "enum", T: () => ["GlobalFailCode", GlobalFailCode] }
        ]);
    }
    create(value?: PartialMessage<S2CProfileResponse>): S2CProfileResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.success = false;
        message.message = "";
        message.failCode = 0;
        if (value !== undefined)
            reflectionMergePartial<S2CProfileResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: S2CProfileResponse): S2CProfileResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: S2CProfileResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* string message = 2; */
        ...
        /* UserData userData = 3; */
        if (message.userData)
            UserData.internalBinaryWrite(message.userData, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* GlobalFailCode failCode = 4; */
        if (message.failCode !== 0)
            writer.tag(4, WireType.Varint).int32(message.failCode);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message S2CProfileResponse
 */
export const S2CProfileResponse = new S2CProfileResponse$Type();
