...
class RoomData$Type extends MessageType<RoomData> {
	...
	create(value?: PartialMessage<RoomData>): RoomData {
		...
		message.state = 0;
		message.users = [];
		if (value !== undefined) reflectionMergePartial<RoomData>(this, message, value);
		return message;
	}
	internalBinaryRead(
	...
	internalBinaryWrite(
		...
		/* int64 ownerId = 2; */
		if (message.ownerId !== '0') writer.tag(2, WireType.Varint).int64(message.ownerId);
		/* string name = 3; */
		if (message.name !== '') writer.tag(3, WireType.LengthDelimited).string(message.name);
		/* int32 maxUserNum = 4; */
		if (message.maxUserNum !== 0) writer.tag(4, WireType.Varint).int32(message.maxUserNum);
		/* RoomStateType state = 5; */
		if (message.state !== 0) writer.tag(5, WireType.Varint).int32(message.state);
...
class UserData$Type extends MessageType<UserData> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* CharacterData character */ 3:
					message.character = CharacterData.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.character,
	...
	internalBinaryWrite(
		...
		if (message.character)
			CharacterData.internalBinaryWrite(
				message.character,
...
class CharacterData$Type extends MessageType<CharacterData> {
	...
	create(value?: PartialMessage<CharacterData>): CharacterData {
		...
		if (value !== undefined) reflectionMergePartial<CharacterData>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* CharacterStateInfoData stateInfo */ 5:
					message.stateInfo = CharacterStateInfoData.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.stateInfo,
				...
				case /* repeated int32 equips */ 6:
					...
					else message.equips.push(reader.int32());
					break;
				case /* repeated int32 debuffs */ 7:
					if (wireType === WireType.LengthDelimited)
						for (let e = reader.int32() + reader.pos; reader.pos < e; )
							message.debuffs.push(reader.int32());
					else message.debuffs.push(reader.int32());
					break;
	...
	internalBinaryWrite(
		...
		if (message.characterType !== 0) writer.tag(1, WireType.Varint).int32(message.characterType);
		/* RoleType roleType = 2; */
		if (message.roleType !== 0) writer.tag(2, WireType.Varint).int32(message.roleType);
		/* int32 hp = 3; */
		if (message.hp !== 0) writer.tag(3, WireType.Varint).int32(message.hp);
		/* int32 weapon = 4; */
		if (message.weapon !== 0) writer.tag(4, WireType.Varint).int32(message.weapon);
		/* CharacterStateInfoData stateInfo = 5; */
		if (message.stateInfo)
			CharacterStateInfoData.internalBinaryWrite(
				message.stateInfo,
		...
		if (message.equips.length) {
			writer.tag(6, WireType.LengthDelimited).fork();
			for (let i = 0; i < message.equips.length; i++) writer.int32(message.equips[i]);
			writer.join();
		}
		/* repeated int32 debuffs = 7; */
		if (message.debuffs.length) {
			writer.tag(7, WireType.LengthDelimited).fork();
			for (let i = 0; i < message.debuffs.length; i++) writer.int32(message.debuffs[i]);
			writer.join();
		}
		...
		/* int32 bbangCount = 9; */
		if (message.bbangCount !== 0) writer.tag(9, WireType.Varint).int32(message.bbangCount);
		/* int32 handCardsCount = 10; */
		if (message.handCardsCount !== 0) writer.tag(10, WireType.Varint).int32(message.handCardsCount);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class CharacterPositionData$Type extends MessageType<CharacterPositionData> {
	...
	create(value?: PartialMessage<CharacterPositionData>): CharacterPositionData {
		...
		message.x = 0;
		message.y = 0;
		if (value !== undefined) reflectionMergePartial<CharacterPositionData>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
	...
	internalBinaryWrite(
		...
		if (message.id !== '0') writer.tag(1, WireType.Varint).int64(message.id);
		/* double x = 2; */
		if (message.x !== 0) writer.tag(2, WireType.Bit64).double(message.x);
		/* double y = 3; */
		if (message.y !== 0) writer.tag(3, WireType.Bit64).double(message.y);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class CardData$Type extends MessageType<CardData> {
	...
	create(value?: PartialMessage<CardData>): CardData {
		...
		message.type = 0;
		message.count = 0;
		if (value !== undefined) reflectionMergePartial<CardData>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
class GameStateData$Type extends MessageType<GameStateData> {
	...
	create(value?: PartialMessage<GameStateData>): GameStateData {
		...
		if (value !== undefined) reflectionMergePartial<GameStateData>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
class CharacterStateInfoData$Type extends MessageType<CharacterStateInfoData> {
	constructor() {
		super('CharacterStateInfoData', [
			{ no: 1, name: 'state', kind: 'enum', T: () => ['CharacterStateType', CharacterStateType] },
			{
				...
				name: 'nextState',
				kind: 'enum',
				T: () => ['CharacterStateType', CharacterStateType],
			},
	...
	create(value?: PartialMessage<CharacterStateInfoData>): CharacterStateInfoData {
		...
		if (value !== undefined) reflectionMergePartial<CharacterStateInfoData>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
	...
	internalBinaryWrite(
		...
		if (message.nextState !== 0) writer.tag(2, WireType.Varint).int32(message.nextState);
		/* int64 nextStateAt = 3; */
		if (message.nextStateAt !== '0') writer.tag(3, WireType.Varint).int64(message.nextStateAt);
