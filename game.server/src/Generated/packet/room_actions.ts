...
class C2SCreateRoomRequest$Type extends MessageType<C2SCreateRoomRequest> {
	...
	create(value?: PartialMessage<C2SCreateRoomRequest>): C2SCreateRoomRequest {
		...
		if (value !== undefined) reflectionMergePartial<C2SCreateRoomRequest>(this, message, value);
		return message;
	}
	internalBinaryRead(
	...
	internalBinaryWrite(
		...
		/* int32 maxUserNum = 2; */
		if (message.maxUserNum !== 0) writer.tag(2, WireType.Varint).int32(message.maxUserNum);
...
class S2CCreateRoomResponse$Type extends MessageType<S2CCreateRoomResponse> {
	...
	create(value?: PartialMessage<S2CCreateRoomResponse>): S2CCreateRoomResponse {
		...
		message.failCode = 0;
		if (value !== undefined) reflectionMergePartial<S2CCreateRoomResponse>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
class C2SGetRoomListRequest$Type extends MessageType<C2SGetRoomListRequest> {
	...
	create(value?: PartialMessage<C2SGetRoomListRequest>): C2SGetRoomListRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<C2SGetRoomListRequest>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
class S2CGetRoomListResponse$Type extends MessageType<S2CGetRoomListResponse> {
	...
	create(value?: PartialMessage<S2CGetRoomListResponse>): S2CGetRoomListResponse {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.rooms = [];
		if (value !== undefined) reflectionMergePartial<S2CGetRoomListResponse>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
class C2SJoinRoomRequest$Type extends MessageType<C2SJoinRoomRequest> {
	...
	create(value?: PartialMessage<C2SJoinRoomRequest>): C2SJoinRoomRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.roomId = 0;
		if (value !== undefined) reflectionMergePartial<C2SJoinRoomRequest>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
	...
	internalBinaryWrite(
		...
		/* int32 roomId = 1; */
		if (message.roomId !== 0) writer.tag(1, WireType.Varint).int32(message.roomId);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class S2CJoinRoomResponse$Type extends MessageType<S2CJoinRoomResponse> {
	...
	create(value?: PartialMessage<S2CJoinRoomResponse>): S2CJoinRoomResponse {
		...
		message.success = false;
		message.failCode = 0;
		if (value !== undefined) reflectionMergePartial<S2CJoinRoomResponse>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
class C2SJoinRandomRoomRequest$Type extends MessageType<C2SJoinRandomRoomRequest> {
	...
	create(value?: PartialMessage<C2SJoinRandomRoomRequest>): C2SJoinRandomRoomRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<C2SJoinRandomRoomRequest>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
		length: number,
		options: BinaryReadOptions,
		target?: C2SJoinRandomRoomRequest,
	): C2SJoinRandomRoomRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
...
class S2CJoinRandomRoomResponse$Type extends MessageType<S2CJoinRandomRoomResponse> {
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: S2CJoinRandomRoomResponse,
...
class C2SLeaveRoomRequest$Type extends MessageType<C2SLeaveRoomRequest> {
	...
	create(value?: PartialMessage<C2SLeaveRoomRequest>): C2SLeaveRoomRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<C2SLeaveRoomRequest>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
class S2CLeaveRoomResponse$Type extends MessageType<S2CLeaveRoomResponse> {
	...
	create(value?: PartialMessage<S2CLeaveRoomResponse>): S2CLeaveRoomResponse {
		...
		message.success = false;
		message.failCode = 0;
		if (value !== undefined) reflectionMergePartial<S2CLeaveRoomResponse>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
