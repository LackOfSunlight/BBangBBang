...
class C2SRegisterRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class S2CRegisterResponse$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class C2SLoginRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class S2CLoginResponse$Type extends MessageType {
    constructor() {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* UserData myInfo */ 4:
                    message.myInfo = UserData.internalBinaryRead(reader, reader.uint32(), options, message.myInfo);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* UserData myInfo = 4; */
        if (message.myInfo)
            UserData.internalBinaryWrite(message.myInfo, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* GlobalFailCode failCode = 5; */
        if (message.failCode !== 0)
            writer.tag(5, WireType.Varint).int32(message.failCode);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
